...
class ScenarioStructureLightingInfoTag(Tag):
    ...
    def _from_corinth_light_definitions(self):
        ...
        for element in self.block_generic_light_definitions.Elements:
            ...
            blender_light.nwo.light_intensity = intensity_mapping.Value.ClampRangeMin
            ...
            elif nwo.light_physically_correct:
                blender_light.energy = blender_light.nwo.light_intensity * (utils.get_import_scale(bpy.context) ** 2)
            else:
