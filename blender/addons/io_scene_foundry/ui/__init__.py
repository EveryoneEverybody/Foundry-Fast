...
classes = [
    ...
    animation.NWO_OT_AnimationsExportChildBlends,
    ...
    animation_name.NWO_OT_AnimationNameSetGraphValue,
    animation_name.NWO_MT_AnimationNameModePicker,
    animation_name.NWO_MT_AnimationNameDestinationModePicker,
    animation_name.NWO_MT_AnimationNameWeaponClassPicker,
    animation_name.NWO_MT_AnimationNameWeaponTypePicker,
    animation_name.NWO_MT_AnimationNameSetPicker,
    animation_name.NWO_MT_AnimationNameStatePicker,
    animation_name.NWO_MT_AnimationNameBunkerSetPicker,
    animation_name.NWO_MT_AnimationNameBunkerStatePicker,
    animation_name.NWO_MT_AnimationNameDestinationStatePicker,
    ...
    asset.NWO_OT_ImportCinematicScenario,
    ...
    object.NWO_OT_SelectParentArmature,
